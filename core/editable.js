	...
	CKEDITOR.editable = CKEDITOR.tools.createClass( {
		...
		proto: {
			...
			insertHtml: function( data, mode, range ) {
				...
				editor.focus();
				console.log("Editable proto: insertHtml(data,mode,range): with data: " + data)
			...
			setup: function() {
				...
				this.attachListener( editor, 'insertHtml', function( evt ) {
					console.log("Editable: insertHtml listener: with evt.data.dataValue: " + evt.data.dataValue)
