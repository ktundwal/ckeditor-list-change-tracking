...
( function() {
	...
	CKEDITOR.htmlDataProcessor = function( editor ) {
		...
		editor.on( 'toHtml', function( evt ) {
			console.log("HtmlDataProcessor: toHtml listener")
		...
		editor.on( 'toHtml', function( evt ) {
			console.log("HtmlDataProcessor: Filter incoming data")
			if ( evt.data.filter.applyTo( evt.data.dataValue, true, evt.data.dontFilter, evt.data.enterMode ) )
				editor.fire( 'dataFiltered' );
		}, null, null, 6 );

		editor.on( 'toHtml', function( evt ) {
			console.log("HtmlDataProcessor: second filter incoming data")
			evt.data.dataValue.filterChildren( that.dataFilter, true );
		}, null, null, 10 );

		editor.on( 'toHtml', function( evt ) {
			console.log("HtmlDataProcessor: third filter incoming data")
			var evtData = evt.data,
				data = evtData.dataValue,
	...
	CKEDITOR.htmlDataProcessor.prototype = {
		...
		toHtml: function( data, options, fixForBody, dontFilter ) {
			...
			console.log("HtmlDataProcessor: toHtml() prototype")
